...
def start_token_extraction(configFilePath, paragraphFilePath, processId, workspace, message):
    try:
        ...
        filename_negative = write_to_csv(negative_tokens, processId, 'Negative-Token', Constants.BASE_PATH_TOOL_1,
                                         workspace)
        ...
        try:
            ...
            log.info(
                "start_token_extraction : process ended for processId == " + str(processId) + " with config name == " +
